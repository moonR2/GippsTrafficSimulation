...
class GippsModel: 
    ...
    def accelerating_part_y(self,car):
        inner = (0.025 + car.speed / car.desired_speed)
    ...
    def decelerating_part_y(self,car):
        inner = (car.desired_braking ** 2) * (car.reac_time ** 2) - car.desired_braking * (2 * (car.leader.location_y -
                car.leader.eff_size - car.y_location) - car.speed *
                car.reac_time - (car.leader.speed ** 2) / car.b_hat)
